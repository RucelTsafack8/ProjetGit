...
if(isset($_POST['envoyer'])){
    ...
    if(strlen($NOM_PRENOMS)<=3 || !preg_match('/^[A-Z][a-zA-Z\s]+$/', $NOM_PRENOMS)){
        ...
        $erreur_adresse = "l'adresse est mal renseigner ";
        $ERREUR++;
    } if($ERREUR<=0){
        ...
        <div class="row  justify-content-center align-items-center w-100 py-2 mt-2">
            <form action="" method="post" class="mt-3 w-50 bg-light" enctype="multipart/form-data">
                ...
                <div class="mt-3">
                    ...
                    <h5 class ="text-center text-danger mt-2"><?php echo $erreur_numero;?></h5>
                ...
                <div class="mt-3">
                    ...
                    <h5 class ="text-center text-danger mt-2 "><?php echo $erreur_email;?></h5>
                ...
                <div class="mt-3">
                    ...
                    <h5 class ="text-center text-danger mt-2"><?php echo $erreur_nom;?></h5>
                </div>

                <div class="mt-3">
                    <label for="DATE_NAISSANCE" class="form-label">DATE DE NAISSANCE</label>
                    <input type="date" name="DATE_NAISSANCE" id="DATE_NAISSANCE" class="form-control" value="<?= $SECRET['DATE_NAISSANCE']?>">
                    <h5 class ="text-center text-danger mt-2"><?php echo $erreur_date;?></h5>
                ...
                <div class="mt-3">
                    ...
                    <h5 class ="text-center text-danger mt-2 "><?php echo $erreur_adresse;?></h5>
                </div> 
                <div class="mt-3">
                    ...
                    <h5 class ="text-center text-danger mt-2 "><?php echo $erreur_nom2; ?></h5>
